...
import { useDonate } from "@/components/overlays/donateModal";
...
function HomeLayoutCustomizerToggle() {
  ...
  // Only show on the exact home page path, and only for logged-in users
  if (!loggedIn || window.location.pathname !== "/") return null;
