...
export interface DetailsContentProps {
  data: DetailsContent;
  minimal?: boolean;
  /** Fired when the cover switches to/from the inline trailer player. */
  onTrailerPlayingChange?: (playing: boolean) => void;
  /** Register a close handler so the parent can render a Close Trailer control. */
  registerCloseTrailer?: (close: (() => void) | null) => void;
}
