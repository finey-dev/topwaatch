...
interface Config {
  ...
  FEBBOX_CLIENT_ID: string;
  FEBBOX_REDIRECT_URI: string;
...
export interface RuntimeConfig {
  ...
  ALLOW_FEBBOX_KEY: boolean;
  FEBBOX_CLIENT_ID: string | null;
  FEBBOX_REDIRECT_URI: string | null;
  SHOW_AD: boolean;
  AD_CONTENT_URL: string[];
  ENABLE_HOME_AD: boolean;
...
const env: Record<keyof Config, undefined | string> = {
  ...
  FEBBOX_CLIENT_ID: import.meta.env.VITE_FEBBOX_CLIENT_ID,
  FEBBOX_REDIRECT_URI: import.meta.env.VITE_FEBBOX_REDIRECT_URI,
...
export function conf(): RuntimeConfig {
  return {
    ...
    DMCA_EMAIL: getKey("DMCA_EMAIL", "topwaatch@gmail.com"),
    ...
    FEBBOX_CLIENT_ID: getKey("FEBBOX_CLIENT_ID"),
    FEBBOX_REDIRECT_URI: getKey("FEBBOX_REDIRECT_URI"),
