...
import { progressItems } from "./progress";
import { userGroupOrder } from "./user-group-order";
...
export const user = pgTable("user", {
  ...
  image: text("image"),
  /** When set, the account is deactivated  data is kept but sessions are rejected. */
